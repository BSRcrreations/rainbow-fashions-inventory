...
class Product(Base):
    ...
    purchase_items = relationship("PurchaseItem", back_populates="product", foreign_keys="PurchaseItem.product_id")
    matched_purchase_items = relationship("PurchaseItem", back_populates="matched_product", foreign_keys="PurchaseItem.matched_product_id")
    stock_movements = relationship("StockHistory", back_populates="product")
