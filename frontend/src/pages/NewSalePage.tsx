  ...
  return (
    <>
      ...
      <div className="grid min-w-0 gap-6 xl:grid-cols-[minmax(0,1fr)_400px]">
        ...
        <form onSubmit={submit} className="h-fit overflow-hidden rounded-lg border border-slate-200 bg-white shadow-[0_8px_28px_rgba(15,23,42,0.08)] xl:sticky xl:top-20">
