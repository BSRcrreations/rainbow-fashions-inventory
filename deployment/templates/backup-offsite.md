...
database/media paths, monitoring thresholds, and staging-only restore target.

The uploader encrypts verified PostgreSQL custom-format dumps and uploaded-media
...
database and media timers pass in staging. The full configuration, validation,
